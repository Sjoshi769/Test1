...
func  (TcpUtilsStructPtr	*TcpUtilsStruct)   ReadTwoBytesFromInput() int {
        var tTemp int
        tTemp = (int) ((TcpUtilsStructPtr.ReadOneByteFromInput() << 8) | (TcpUtilsStructPtr.ReadOneByteFromInput() & 0x00FF)); 
...
func  (TcpUtilsStructPtr	*TcpUtilsStruct)    SendSocketData() {
        ...
        for ;TcpUtilsStructPtr.outputBufferDipstick>0; {
   			...
   			err :=  TcpUtilsStructPtr.writer.WriteByte(TcpUtilsStructPtr.GetByteFromOutputBuff())
			if err != nil {
